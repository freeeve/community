...
public interface UdcSettings
{
     ...
     */
    @Default(TRUE)
    public static final GraphDatabaseSetting.BooleanSetting udc_enabled = new GraphDatabaseSetting.BooleanSetting(
     ...
     */
    @Default("" + 10 * 1000 * 60)
    public static final GraphDatabaseSetting.IntegerSetting first_delay = new GraphDatabaseSetting.IntegerSetting(
            "neo4j.ext.udc.first_delay", "Must be nr of milliseconds to delay", 1, null );
    ...
    public static final GraphDatabaseSetting.IntegerSetting interval = new GraphDatabaseSetting.IntegerSetting(
            "neo4j.ext.udc.interval", "Must be nr of milliseconds of the interval for checking", 1, null );
    ...
    public static final GraphDatabaseSetting.StringSetting udc_host = new GraphDatabaseSetting.StringSetting( "neo4j" +
            ".ext.udc.host", ANY, "Must be a valid hostname" );

    /**
     * Configuration key for overriding the source parameter in UDC
     */
    public static final GraphDatabaseSetting.StringSetting udc_source = new GraphDatabaseSetting.StringSetting(
            "neo4j.ext.udc.source", ANY, "Must be a valid source" );
